    ...
    },
    {
        ...
        inputSchema: {
            ...
            properties: {
                ...
                column_id: {
                    type: "string",
                    description: "The ID of the column to delete (provide either column_id or column_name)",
                },
                column_name: {
                    type: "string",
                    description: "The name of the column to delete (provide either column_id or column_name)",
                },
            },
            required: ["table_id"],
        },
        handler: async (client, args) => {
            ...
            if (!columnId && args.column_name) {
                ...
                const column = columns.find((col) => col.column_name === args.column_name ||
