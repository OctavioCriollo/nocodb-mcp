...
exports.recordTools = [
    ...
    },
    {
        ...
        handler: async (client, args) => {
            const record = await client.updateRecord(args.base_id, args.table_name, args.record_id, args.data);
            return {
                record,
    ...
    },
    {
        ...
        handler: async (client, args) => {
            const result = await client.searchRecords(args.base_id, args.table_name, args.query, {
                where: args.where,
                sort: args.sort,
                limit: args.limit,
                offset: args.offset,
