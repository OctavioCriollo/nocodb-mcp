...
exports.attachmentTools = [
    {
        ...
        handler: async (client, args) => {
            ...
            try {
                const result = await client.uploadFile(args.file_path, args.storage_path);
                return {
                    success: true,
                    file_name: fileName,
    ...
    },
    {
        ...
        handler: async (client, args) => {
            try {
                ...
                await client.updateRecord(args.base_id, args.table_name, args.record_id, {
    ...
    },
    {
        ...
        handler: async (client, args) => {
            ...
            const attachmentData = typeof attachments === "string" ? JSON.parse(attachments) : attachments;
            return {
